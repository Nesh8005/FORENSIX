...
class FileAnalyzer:
    ...
    def analyze(self, deep=False):
        ...
        try:
            ...
            # 5. Steganography Check (Images - usually small enough, but check size)
            ...
            if "pcap" in self.filetype:
                from forensix.modules.pcap_analyzer import PcapAnalyzer
            ...
            if "audio" in self.filetype or self.filepath.endswith(('.wav', '.mp3')):
                from forensix.modules.audio import AudioAnalyzer
            ...
            if "memory-dump" in self.filetype or self.filesize > 500 * 1024 * 1024:
                ...
                if self.filesize > 1024*1024:
                     from forensix.modules.memory import MemoryAnalyzer
            ...
            if self.filepath.endswith(('.docx', '.xlsx', '.pptx', '.pdf')):
                from forensix.modules.metadata import MetadataExtractor
